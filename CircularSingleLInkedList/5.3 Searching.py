    ...
    def traversalCSLL(self):
        if self.head is None:
            ...
            while tempNode:
                ...
                tempNode=tempNode.next
                if tempNode==self.tail.next:  # it  is not clear for me
                    break
# Searching for a node  in  circular singly  linked list 
 
    def  seacrchCSLL(self,nodeValue):
        if self.head is None:
            ...
            while tempNode:
                ...
                tempNode=tempNode.next
                if tempNode==self.tail.next: # why having self.tail.next . does it is necessary 
                    break
            return "The required numbers is not found"
...
print(circularSLL.seacrchCSLL(4))
print(circularSLL.seacrchCSLL(1))
print(circularSLL.seacrchCSLL(6))